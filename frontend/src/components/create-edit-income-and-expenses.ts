...
import {CategoriesAllResponseType} from "../types/responses/categories-all-response.type";
import {ActionsCategoriesType} from "../types/actions-categories.type";
import {OperationResponseType} from "../types/responses/operation-response.type";
...
export class CreateEditIncomeAndExpenses {
    ...
    private async init(): Promise<void> {
        ...
        this.cancelButtonElement = document.getElementsByClassName('btn-danger')[0] as HTMLElement;
