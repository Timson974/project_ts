...
import {BalanceResponseType} from "../types/responses/balance-response.type";
...
export class Sidebar {
    ...
    private cancelBalanceButtonElement: HTMLElement | null;
    ...
    private async editBalance(): Promise<void> {
        ...
        this.cancelBalanceButtonElement.setAttribute('id', 'canselEditBalance');
        ...
        this.cancelBalanceButtonElement.appendChild(canselImageElement);
        ...
        this.cancelBalanceButtonElement.addEventListener('click', () => that.cancelSaveBalance());
        this.saveBalanceButtonElement.addEventListener('click', () => that.saveBalance());
    }

    private cancelSaveBalance(): void {
        ...
        this.cancelBalanceButtonElement && this.cancelBalanceButtonElement.remove();
    }
